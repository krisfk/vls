    ...
    <div class="middle-content">
        ...
        <div class="container">
            <div class="breadcrumb mt-3"><a href="./"><img class="reg-icon" src="./images/reg-icon.png" alt=""> <a
                        href="./" class="home-txt"> 好想買嘢 VLoveShopping</a> <span class="arrow">></span> <a
                        href="javascript:void(0)">
                        日本市集</a> <span class="arrow">></span><a href="javascript:void(0)">
                        日本賀禮之選</a><span class="arrow">></span><a href="javascript:void(0)">
                        日本市集 - 日版棒子朱古力夾心酥餅禮盒(1盒7件)</a>
            </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12  col-12 mobile-enlarge-video-col">
                    <div class="row g-0">

                        <div class="col-12">

                            <div class="product-detail enlarge-video-div ">

                                <div class="video-img-div"> <img class="dummy" src="./images/video-img.jpg" alt="">
                                </div>

                            </div>


                            <h1 class="product-name d-inline-block col-lg-9 col-md-12 col-sm-12 col-12 ">
                            ...
                            <ul class="category-tag p-0 col-9">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12 desktop-product-img-col">
                            ...
                            <ul class="product-thumbnail-ul p-0 m-0 text-center">
                        ...
                        <tr>
                            ...
                            <a href="javascript:void(0);" class="cart-btn add  mt-3"> <img src="./images/cart-icon2.png"
                                    alt="">
                                加入購物車</a>
                ...
                <div class="col-3 product-detail-right-col">
                    ...
                    <div class=" video-player-col-div float-none">
                        <div class="video-player-div foot-bg w-100">
                            <a href="./snoopy.php" class="campaign-url"></a>

                            <div class="text-center  pt-1 pb-1 fw-bold d-block text-center">史路比奇幻世界</div>
